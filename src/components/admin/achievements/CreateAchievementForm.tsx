...
import { AchievementRequirement, AchievementReward } from '@/app/admin/achievements/types';
...
export const CreateAchievementForm: React.FC<CreateAchievementFormProps> = ({
  ...
  const RequirementsStep = () => (
    <Card title="🎯 Yêu cầu hoàn thành" variant='borderless'>
      <div style={{ marginBottom: 16 }}>
        <Button
          ...
          onClick={
            () => {
              //setRequirements([...requirements, createNewRequirement()])
            }
  ...
  // Rewards Step
  const RewardsStep = () => (
    <Card title="🎁 Phần thưởng" variant='borderless'>
      <div style={{ marginBottom: 16 }}>
        <Button
          type="dashed"
          icon={<PlusOutlined />}
  ...
  const AdvancedSettingsStep = () => (
    <Card title="⚙️ Cài đặt nâng cao" variant='borderless'>
      <Row gutter={[16, 16]}>
        <Col span={12}>
          <Form.Item
            name="shareable"
  ...
  return (
    ...
    >
      <div style={{ marginTop: 8 }}>
        <Switch
          onChange={(checked) => onUpdate({ ...requirement, })}
          size="small"
        />
