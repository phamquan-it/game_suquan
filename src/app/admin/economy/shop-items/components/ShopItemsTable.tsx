// app/admin/economy/shop-items/components/ShopItemsTable.tsx
'use client'
...
export const ShopItemsTable = ({ data, loading }: ShopItemsTableProps) => {
    ...
    const columns: ColumnsType<ShopItemType> = [
        {
            title: 'Icon',
            dataIndex: 'item_icon',
            key: 'icon',
                  ...
                  },
        {
            ...
            dataIndex: 'rarity',
            key: 'rarity',
            render: (rarity: ShopItemRarity) => rarity && (
                <Tag color={rarityColors[rarity]}>{rarity.toUpperCase()}</Tag>
            ),
                 },
        {
            title: 'Status',
            dataIndex: 'status',
            key: 'status',
            render: (status: ShopItemStatus) => status && (
        ...
        },
        {
            title: 'Components',
            key: 'components',
            render: (_: any, record: ShopItemWithComponents) => (
