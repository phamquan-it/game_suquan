...
// Dynamic import with optional loading fallback
const SystemHealth = dynamic(() => import('./components/SystemHealth'), {
  ssr: false, // optional: set true if you want server-side rendering
  loading: () => <p>Loading System Health...</p>, // fallback while loading
});
