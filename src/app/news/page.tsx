...
const NewsPage = () => {
  ...
  const newsCategories = [
    { key: 'all', name: 'Tất Cả', color: '#8B0000', icon: <CrownOutlined /> },
    { key: 'update', name: 'Cập Nhật', color: '#D4AF37', icon: <ClockCircleOutlined /> },
    { key: 'event', name: 'Sự Kiện', color: '#003366', icon: <CalendarOutlined /> },
    { key: 'tournament', name: 'Giải Đấu', color: '#2E8B57', icon: <TrophyOutlined /> },
    { key: 'guide', name: 'Hướng Dẫn', color: '#CD7F32', icon: <BookOutlined /> },
    { key: 'community', name: 'Cộng Đồng', color: '#9370DB', icon: <TeamOutlined /> }
  ];
  ...
  const NewsCard = ({ news, featured = false }: { news: any, featured?: boolean }) => (
    <Card
      ...
      styles={{ body: { padding: featured ? '24px' : '16px' } }}
        ...
        <Space direction="vertical" style={{ width: '100%' }} size="small">
          ...
          <Space direction="vertical" style={{ width: '100%' }} size="small">
            ...
            <Space style={{ width: '100%', justifyContent: 'space-between' }}>
              ...
              <Space size="large">
                <Space size="small">
                  <EyeOutlined style={{ color: '#8B4513' }} />
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{
              ...
              <BookFilled style={{ fontSize: '20px', color: '#FFFFFF' }} />
            </div>
            <Title level={3} style={{
              margin: 0,
              color: '#D4AF37',
      ...
      <Content style={{ padding: '40px 20px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          {filteredNews.length === 0 && (
            ...
            >
              <Space direction="vertical" size="large">
                <BookOutlined style={{ fontSize: '48px', color: '#8B0000', opacity: 0.5 }} />
