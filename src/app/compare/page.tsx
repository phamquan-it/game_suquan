...
import { GitCompare, Shield, Sword } from 'lucide-react';
...
const ComparePage = () => {
  ...
  const statsComparison = [
    { key: 'attack', name: 'Tấn Công', icon: <Sword style={{ fontSize: '14px' }} />, color: '#ff4d4f' },
    { key: 'defense', name: 'Phòng Thủ', icon: <Shield style={{ fontSize: '14px' }} />, color: '#1890ff' },
    { key: 'intelligence', name: 'Trí Tuệ', icon: <AimOutlined style={{ fontSize: '14px' }} />, color: '#52c41a' },
    { key: 'speed', name: 'Tốc Độ', icon: <ArrowUpOutlined style={{ fontSize: '14px' }} />, color: '#faad14' },
    { key: 'leadership', name: 'Lãnh Đạo', icon: <CrownOutlined style={{ fontSize: '14px' }} />, color: '#722ed1' },
    { key: 'charisma', name: 'Uy Tín', icon: <StarOutlined style={{ fontSize: '14px' }} />, color: '#13c2c2' }
  ];
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{
              ...
              <GitCompare style={{ fontSize: '20px', color: '#FFFFFF' }} />
            </div>
            <Title level={3} style={{
              margin: 0,
              color: '#D4AF37',
                ...
                <div style={{
                  ...
                  <Space direction="vertical" style={{ width: '100%' }} size="middle">
                    ...
                    <Statistic
                      ...
                      valueStyle={{ color: '#D4AF37' }}
                      prefix={<BarChartOutlined style={{ fontSize: '16px' }} />}
                    />
                    <Statistic
                      title="So Sánh Hoàn Thành"
                      value={selectedCharacters.length > 1 ? '100%' : '0%'}
                      valueStyle={{ color: '#D4AF37' }}
                      prefix={<RiseOutlined style={{ fontSize: '16px' }} />}
                    />
                  </Space>
                </div>
              </Col>
            ...
            <Row gutter={[16, 16]} align="middle">
              ...
              <Col xs={12} md={6}>
                <Select
                  ...
                  style={{ width: '100%' }}
                  suffixIcon={<FilterOutlined style={{ fontSize: '14px' }} />}
                >
            ...
            {selectedCharacters.length > 0 && (
              <Col xs={24} lg={16}>
                <Card
                  ...
                  title={
                    <Space>
                      <BarChartOutlined style={{ color: '#8B0000' }} />
                      ...
                      <Row gutter={[16, 16]}>
                        <Col xs={12} md={6}>
                          <Statistic
                            ...
                            prefix={<TrophyOutlined style={{ fontSize: '16px' }} />}
                          />
                        </Col>
                        <Col xs={12} md={6}>
                          <Statistic
                        ...
                        <Col xs={12} md={6}>
                          <Statistic
                            ...
                            prefix={<EnvironmentOutlined style={{ fontSize: '16px' }} />}
                          />
                        </Col>
                      </Row>
                    </Card>
